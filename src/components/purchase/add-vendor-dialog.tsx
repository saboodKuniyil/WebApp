...
import { createVendorAction, getNextVendorId } from '@/app/purchase/vendors/actions';
...
export function AddVendorDialog() {
  const [state, dispatch] = useActionState(createVendorAction, initialState);
  ...
  React.useEffect(() => {
    if (isOpen) {
      getNextVendorId().then(setNextId);
    }
  }, [isOpen]);
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>Fill in the details to create a new vendor.</DialogDescription>
        </DialogHeader>
