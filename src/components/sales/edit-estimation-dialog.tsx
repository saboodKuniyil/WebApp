...
import type { EstimationItem, EstimationTask, Estimation } from './estimations-list';
...
export function EditEstimationDialog({ estimation, products, isOpen, setIsOpen }: EditEstimationDialogProps) {
    ...
    const taskCounterRef = React.useRef(Date.now());
                    ...
                    <ScrollArea className="h-[70vh] pr-4">
                        <div className="grid gap-4 py-4">
                            ...
                            <div className="grid grid-cols-4 items-center gap-4">
                                ...
                                <Input id="title" name="title" className="col-span-3" defaultValue={estimation.title} />
                            ...
                            <div className="grid grid-cols-4 items-center gap-4">
                                ...
                                <Select name="customerName" defaultValue={estimation.customerName}>
