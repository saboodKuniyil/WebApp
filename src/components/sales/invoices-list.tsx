...
export function InvoicesList({ data, salesOrders }: InvoicesListProps) {
  ...
  },
  {
  ...
  },
   {
    ...
    cell: ({ row }) => (
       <Link href={`/sales/sales-orders/${row.original.salesOrderId}`} className="font-medium hover:underline text-primary">
          {row.getValue('salesOrderId')}
      </Link>
    ),
  },
  {
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem asChild>
                <Link href={`/sales/invoices/${row.original.id}`}>View Invoice</Link>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      );
